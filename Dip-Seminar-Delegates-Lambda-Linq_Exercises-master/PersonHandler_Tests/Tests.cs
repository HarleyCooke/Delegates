...
namespace PersonHandler_Tests {
    ...
    public class Tests {
        ...
        private string csvPath = "C:/Users/Owner/Documents/Diploma Weekly Task 11/Dip-Seminar-Delegates-Lambda-Linq_Exercises-master/Files"; // change to appropriate path
