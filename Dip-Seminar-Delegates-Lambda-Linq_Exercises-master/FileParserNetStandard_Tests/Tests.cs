...
namespace FileParserNetStandard_Tests {
    ...
    public class Tests {
        ...
        private string _csvPath = "C:/Users/Owner/Documents/Diploma Weekly Task 11/Dip-Seminar-Delegates-Lambda-Linq_Exercises-master/Files/myData.csv";  // change to appropriate path
        private string _tsvPath = "C:/Users/Owner/Documents/Diploma Weekly Task 11/Dip-Seminar-Delegates-Lambda-Linq_Exercises-master/Files/data.tsv";  // change to appropriate path

        private string _writeFile = "C:/Users/Owner/Documents/Diploma Weekly Task 11/Dip-Seminar-Delegates-Lambda-Linq_Exercises-master/Files/dataWrite.txt";  // change to appropriate path
